...
本教材が依拠する主要な出典。各章末の「出典」節はここに集約する。参照日を必ず記録する。

## 言語規範・辞書

| 出典 | 用途 | URL |
|---|---|---|
| Academia Română, *DOOM3 — Dicționarul ortografic, ortoepic și morfologic al limbii române*, ed. a III-a, 2021 | 正書法・正音法・形態論の最終規範 | https://doom.lingv.ro/ (公式オンライン版) |
| *DEX — Dicționarul explicativ al limbii române* (Academia Română, Institutul de Lingvistică „Iorgu Iordan – Alexandru Rosetti") | 語義の基準 | https://dexonline.ro/ (集約サイト) |
| Institutul de Lingvistică „Iorgu Iordan – Alexandru Rosetti" | 言語研究・規範文法 | https://www.lingv.ro/ |
| Consiliul Europei, *CEFR — Common European Framework of Reference for Languages* | レベル定義(A1〜C2) | https://www.coe.int/en/web/common-european-framework-reference-languages |

## 政府・公的機関(ルーマニア)

| 出典 | 用途 | URL |
|---|---|---|
| Guvernul României | 行政制度 | https://gov.ro/ |
...
- 章ごとの参照日は各章末の「出典」節に記す。
- 本ファイルの URL 生存確認: 2026-07-02 時点で作成(以後、年 1 回の再確認を推奨)。

## 執筆者向け注意

- ここに載っていない出典を使う場合は、[SOURCE_POLICY.md](./SOURCE_POLICY.md) の信頼度基準を満たすことを確認し、本ファイルに追記する。
- 「避ける出典」(個人ブログ・SEO 記事・検証不能な SNS)は追記不可。
